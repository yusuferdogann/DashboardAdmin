...
const Login: React.FC = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log("response-----------------------",loginuser.status)
      ...
      if(response.success){
        ...
        setTimeout(()=>{
          // navigate("/facility")
          // window.location.assign('https://slave.carbonistan.com/facility')
            ...
            <form onSubmit={handleSubmit}>
              ...
              <svg
                ...
                <div className="mb-6">
                  ...
                  <Icon className="absolute mr-5 mt-5 fill-current" style={{opacity:'.5'}} icon={icon} size={22} fill='none'/>
                    </span>
                    </span>
                  </div>
                </div>
