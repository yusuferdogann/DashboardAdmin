  ...
  {pdfcontrol ?   <BlobProvider document={<PdfView /> }>
    ...
    <a href={url} target="_blank">Open in new tab</a>
      ...
      <div className="flex flex-col mb-4">
        ...
        <div className="mt-7">
          <select className='py-1 px-4 h-8 border border-gray-300 text-gray-600 text-base rounded-lg block w-full py-1 px-4 focus:outline-none' onChange={(event)=>changeControl(event)}>
