...
const userRole = Role; // Bunu gerçek token veya context'ten çekebilirsin
  ...
  return (
    <>
     {checkSpinner ? (
  token ? (
    // Eğer token varsa normal yükleme spinner'ını göster
    <div
      role="status"
    ...
    >
      <svg
        aria-hidden="true"
        className="selam w-8 h-8 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600"
        viewBox="0 0 100 101"
        fill="none"
    ...
    >
      <div className="bg-white p-6 rounded-lg shadow-lg text-center">
        ...
        <button
          onClick={() => (window.location.href = '/login')} // Giriş sayfasına yönlendirme
