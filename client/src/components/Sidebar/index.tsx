...
// console.log("data-----------------",object.company_logo)
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute left-0 top-0 z-0 flex h-screen w-72.5 xsm:z-[999] flex-col overflow-y-hidden bg-black duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0 ${
